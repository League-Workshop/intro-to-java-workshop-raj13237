...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		int choice = JOptionPane.showOptionDialog(null, "What move would you like to do", "Dragon Fight", 0, JOptionPane.INFORMATION_MESSAGE, null,
				new String[] {"Yell", "Kick"}, null);
